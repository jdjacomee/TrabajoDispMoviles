package ec.edu.uce.dispmoviles.cap2.ejer17;
...
public class ToolbarActivity extends ActionBarActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cap2_ejer17_activity_toolbar);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.cap2_ejer17_main, menu);
        return true;
    }

    @Override
    public boolean onPrepareOptionsMenu(Menu menu) {
        //Display the action options based on cap1_ejer1_main drawer state
        boolean isOpen =
    ...
    //Handle click events from items in the list of our cap1_ejer1_main drawer
    @Override
    public void onItemClick(AdapterView<?> parent, View view,
                            int position, long id) {
        //Update the background color of the cap1_ejer1_main content
