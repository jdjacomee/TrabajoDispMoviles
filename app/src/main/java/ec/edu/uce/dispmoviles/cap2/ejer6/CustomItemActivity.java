package ec.edu.uce.dispmoviles.cap2.ejer6;
...
public class CustomItemActivity extends Activity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> adapter = new ArrayAdapter<String>(this, R.layout.cap2_ejer6_list_item) {
            @Override
            public View getView(int position, View convertView, ViewGroup parent) {
                View row = convertView;
                if (row == null) {
                    row = getLayoutInflater().inflate(R.layout.cap2_ejer6_list_item, parent, false);
                }
