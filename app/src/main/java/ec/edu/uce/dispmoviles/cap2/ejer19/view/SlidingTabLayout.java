...
package ec.edu.uce.dispmoviles.cap2.ejer19.view;
...
public class SlidingTabLayout extends HorizontalScrollView {
    ...
    public SlidingTabLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        //Obtain the tab colors, use theme default if not defined
    ...
    //Update tab text colors on each selection change
    private void updateSelectedTitle(int position) {
        ...
        for (int i = 0; i < adapter.getCount(); i++) {
            ...
            if (TextView.class.isInstance(tabView)) {
                ...
                titleView.setTextColor(isSelected ? mSelectedTextColor
                        : mDefaultTextColor);
            }
        }
    }
